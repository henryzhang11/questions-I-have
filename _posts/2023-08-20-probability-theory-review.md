...
1. If $\mu$ is unknown and $\sigma$ is known, reject $\mu=\mu_0$ with confidence level $\alpha$ if $P(\mathcal{N}(\mu_0,\sigma^2/n)\geq\overline{X})\leq\alpha/2$ or $P(\mathcal{N}(\mu_0,\sigma^2/\sqrt{n})\leq\overline{X})\leq\alpha/2$; reject $\mu\leq\mu_0$ if $\frac{\overline{X}-\mu_0}{\sigma/\sqrt{n}}\notin(-\infty,z_{\alpha})$ or $P(\mathcal{N}(\mu_0,\sigma/\sqrt{n})\geq \overline{X})\leq\alpha$; reject $\mu\geq\mu_0$ if $\frac{\overline{X}-\mu_0}{\sigma/\sqrt{n}}\notin(-z_{\alpha},\infty)$ or $P(\mathcal{N}(\mu_0,\sigma/\sqrt{n})\leq \mu)\leq\alpha$.
