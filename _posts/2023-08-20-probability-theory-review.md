...
1. If $\mu$ is unknown and $\sigma$ is known, reject "$\mu=\mu_0$" with p-value $\alpha$ if $\mu_0\notin(\overline{X}\pm z_{\alpha/2}\sigma/\sqrt{n})$; reject "$\mu\leq\mu_0$" if $\mu_0\notin(\overline{X}-z_{\alpha}\sigma/sqrt{n},\infty)$; reject "$\mu\geq\mu_0$" if $\mu_0\notin(-\infty,\overline{X}+z_{\alpha}\sigma/\sqrt{n})$.
